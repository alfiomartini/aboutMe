const texts = {
  overview: `
    ...
    when when I first met the need to work with position, float and display properties like flex and grid. You have to have a working knowledge of HTML to use well how
  ...
  that make creating web applications in Python easier. It gives developers 
  ...
  object oriented programming, iterables  and query sets in Python to feel comfortable with this framework. A basic knowledge of regular expressions is also helpful. There
  is also quite a lot of boilerplate code to generate before you even start coding your first routes and views. On the other hand, Django is a data-driven framework, offering
  a great number of tools to create your data models and their automatic map to database structures.
  `,
  react: `
  In a nutshell, ReactJS is JavaScript library for building user interfaces. It takes
  a completely different approach to web development of frontend user interfaces. Instead of the usual separation of concerns, i.e., different files for styling, HTML
  markup and script logic, React emphasizes the development of independent, reusable
